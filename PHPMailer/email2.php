...
function sendMail($email, $subject, $message)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'jhayzhelle123@gmail.com';  // Your email
        $mail->Password = 'iqklcamnytuyahxed';      // Your app password if 2FA is enabled
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Sender and recipient settings
        $mail->setFrom('jhayzhelle123@gmail.com', 'Your Name');
